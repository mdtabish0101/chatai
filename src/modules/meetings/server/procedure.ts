...
import { DEFAULT_PAGE, DEFUALT_PAGE_SIZE, MAX_PAGE_SIZE, MIN_PAGE_SIZE } from "@/constants";
        ...
        .query(async ({ input, ctx }) => {
            ...
            const agentSpeakers = await db
                ...
                .then((agents) =>
                    agents.map((agent) => ({
                        ...agent,
                        image: generateAvatarUri({ seed: agent.name, variant: "bottts" }),
                    }))
                );
